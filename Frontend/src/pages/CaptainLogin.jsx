...
const CaptainLogin = () => {
  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between'>
        <div>
            <img className='w-20 mb-2' src="https://pngimg.com/d/uber_PNG24.png" alt="Uber logo" />
            <form onSubmit={(e)=>{submitHandler(e)}}>
                <h3 className='text-lg font-medium mb-2'>What's your Email?</h3>
                <input value={email} onChange={(e)=>{setemail(e.target.value)}} className='bg-[#eeeeee] mb-7 rounded px-4 py-2 border w-full text-lg placeholder:text-base' required type="email" placeholder='Email' />
